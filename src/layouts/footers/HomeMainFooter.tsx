                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-4 col-lg-4">
                            <div className="tp-footer-widget tp-footer-col-1 pb-40 tp_fade_anim" data-delay=".3">
                                <h4 className="tp-footer-widget-title">Our goal is to  <br /> exceed expectations</h4>
                                {/* footer social icons */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7">
                                ...
                                <div className="tp-footer-widget-info">
                                    <Link href="mailto:agntixs@studio.com">info@saconglobalsportspark.com</Link>
                                    <Link href="tel:+3025550107">+(91) 989 546 2960</Link>
                                </div>
                                <div className="tp-footer-widget-info">
                                    <Link href="https://www.google.com/maps/" target="_blank">Room No. 304, Nehrupark Avenue Bldg. Bank Junction,  <br />
                                        Aluva, Kochi – 683 101</Link>
                                </div>
                            </div>
                        </div>
                    </div>
