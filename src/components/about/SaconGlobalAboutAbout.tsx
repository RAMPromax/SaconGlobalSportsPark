...
import aboutShape from '../../../public/assets/img/sacon-global/about/about-shape.png';
import aboutBg from '../../../public/assets/img/sacon-global/hero/hero-bg-shape-2.png';
import about1 from '../../../public/assets/img/sacon-global/about/about-1.jpg';
import about2 from '../../../public/assets/img/sacon-global/about/about-2.jpg';
import Image from 'next/image';
import Link from 'next/link';
import { ArrowFour } from '@/svg';

const SaconGlobalAbout = () => {
    return (
                    ...
                    <div className="row align-items-end">
                        <div className="col-xl-8 col-lg-8">
                            <div className="ar-about-title-box">
                                <span className="tp-section-subtitle-satisfy mb-20 tp_fade_anim" data-delay=".3">About Sacon Global</span>
                                <h3 className="tp-section-title-clash-600 fs-60 fw-400 mb-0 pb-40 tp_fade_anim" data-delay=".4">
                                    Welcome to SACON Global Sports Park pvt. ltd - India’s Premier All-in-One Sports Destination
                                </h3>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-10 order-1 order-lg-0">
                        <div className="ar-about-content">
                            <h3 className="ar-about-title-sm tp_fade_anim" data-delay=".3">
                                Sacon Global Sports Park pvt.ltd stands as a pioneering model in India’s sports
                            </h3>
                            <div className="tp_fade_anim" data-delay=".4">
                                <p>
                                    infrastructure landscape, offering world-class, multi-disciplinary training and competition facilities under one roof. Designed to foster excellence and accessibility, Sacon is a haven for athletes, sports academies, and event organizers alike.
...
export default SaconGlobalAbout;