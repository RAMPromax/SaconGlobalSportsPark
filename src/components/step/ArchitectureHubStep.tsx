...
import StepBg from '../../../public/assets/img/sacon-global/step/step-bg.jpg';
import { StepItemDT } from '@/types/custom-d-t';

const SaconGlobalStep = () => {
  const steps: StepItemDT[] = [
    {
      id: 1,
      number: '01',
      title: 'Main Football Grounds',
...
export default SaconGlobalStep;