import bannerShape from '../../../public/assets/img/sacon-global/banner/banner-shape.png';
import banner from '../../../public/assets/img/sacon-global/banner/banner.jpg';
import Image from 'next/image';

const SaconGlobalBanner = () => {
    return (
...
export default SaconGlobalBanner;