import heroBgShape from '../../../public/assets/img/sacon-global/hero/hero-bg-shape.png';
...
Sports Destination <span><Image className="ar-hero-shape-3 d-none d-md-inline-block" src={shape3} alt="hero-shape" /></span><i></i>
                                </h2>
                            </div>
...
export default SaconGlobalHero;